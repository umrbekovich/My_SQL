...
select OrderID, FirstName+' '+LastName as CustomerName, OrderDate from Orders o
join Customers c
...
select  DepartmentName, max(Salary) as MaxSalary from Employees e
join Departments d
on e.DepartmentID=d.DepartmentID
...
join Customers c
on o.CustomerID=c.CustomerID
where YEAR(OrderDate)>2022 and Country='usa'


--task5 #

select  FirstName+' '+LastName as CustomerName, Quantity as totalOrders from Orders o
join Customers c
on o.CustomerID=c.CustomerID
...
--task7
select c.CustomerID, FirstName+' '+LastName as CustomerName, max(o.OrderDate) as MostRecentOrderDate from Customers c
left join  Orders o
on o.CustomerID=c.CustomerID
group by c.CustomerID, c.LastName, c.FirstName

--task8
select OrderID, FirstName+' '+LastName as CustomerName, TotalAmount  from Orders o
join Customers c
on o.CustomerID=c.CustomerID
...
select ProductName, sum(SaleAmount) as TotalSalesAmount from Products p
join sales s
...
select  name, DepartmentName, Salary from Employees e
join Departments d
on e.DepartmentID=d.DepartmentID
...
select  name, DepartmentName, HireDate from Employees e
join Departments d
on e.DepartmentID=d.DepartmentID
...
select OrderID, FirstName+' '+LastName as CustomerName, Address, OrderDate from Orders o
join Customers c
on o.CustomerID=c.CustomerID
...
select ProductName,CategoryName, SaleAmount from Products p
join sales s
on p.ProductID=s.ProductID
join Categories c
...
select CategoryName, count(ProductID) as productCount from Products p
join Categories c
...
select FirstName+' '+LastName as CustomerName, City, OrderID, TotalAmount from Customers c
join Orders o
...
join Departments d
on e.DepartmentID=d.DepartmentID
WHERE DepartmentName IN ('HR', 'Finance') or Name like '%[aeiou]%[aeiou]%[aeiou]%[aeiou]%'
